    ...
    //  this.listQr.clear();
     print('lista de diccionarios actuales');
      ...
      if(datos.data()!=null){
        ...
        list_datos.clear();
        print(':::::::::::::::::::::::::::::::::::::::::');
        final dato_ids=(datos.data() as dynamic)['ids'];
        
        int len_=dato_ids.length;
        for (var i = 0; i < len_; i++) {
           await datosCompletos.collection(dato_ids[i]).orderBy('fecha',descending: true).get().then((value) {
